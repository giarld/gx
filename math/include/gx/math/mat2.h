...
#ifndef GX_MATH_MAT2_H
#define GX_MATH_MAT2_H
...
public:
    ...
    constexpr explicit TMat22(row_major_init c) noexcept
        : TMat22(std::move(c.m))
    {
    }
    ...
    template<typename A>
    constexpr static TMat22 translation(const TVec2<A> &t) noexcept
    {
        TMat22 r;
        r[2] = t;
        return r;
    ...
    template<typename A>
    constexpr static TMat22 scaling(const TVec2<A> &s) noexcept
    {
        return TMat22{s};
    }

    template<typename A>
    constexpr static TMat22 scaling(A s) noexcept
    {
...
{
template<typename T>
constexpr void swap(math::details::TMat22<T> &lhs,
                    math::details::TMat22<T> &rhs) noexcept
{
