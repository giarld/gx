...
#ifndef GX_MATH_FAST_H
#define GX_MATH_FAST_H
...
constexpr float ilog2(float x) noexcept
{
    union
    {
        float val;
...
inline float isqrt(float x) noexcept
{
...
inline double isqrt(double x) noexcept
{
#if defined(__ARM_NEON) && defined(__aarch64__)
