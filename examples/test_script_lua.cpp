...
int main(int argc, char *argv[])
{
    ...
    ss << "9. test_math.lua" << std::endl;
    ss << "10. test_table.lua" << std::endl;
    ss << "11. test_env" << std::endl;
    ss << "12. test_iterator" << std::endl;
    ss << "0. all" << std::endl;
    ...
    switch (index) {
        ...
        case 9: {
            GFile evalFile(GFile(GX_EXAMPLE_DIR), "lua/test_math.lua");
